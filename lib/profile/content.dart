       ...
       return new Container(
         child: new Row(
           ...
           children: <Widget>[
             ...
             new Text(planet.gravity, style: Style.commonTextStyle),
           ]
         ),
       );
     }
     ...
     final planetCardContent = new Container(
       ...
       child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(planet.location, style: Style.smallTextStyle), 
          new Container(
