...
class ItemDirectory {
  ...
  ItemDirectory() {
    ...
    List.of([
      ...
      Item(type: ItemType.top, prefab: "top_leafa_green"), name: "Green Shirt", desc: "Just a few more pieces of apparel till you can stand at the edge of a rainbow."),
      Item(type: ItemType.top, prefab: "top_shirt_white"), name: "White Shirt", desc: "Plain and Simple, no need for fancy shirts when you have fancy hair."),
      Item(type: ItemType.bottom, prefab: "bottom_leafa_green"), name: "Green Shorts", desc: "For all you environmentalist folks out there..."),
      Item(type: ItemType.bottom, prefab: "bottom_short_blue"), name: "Blue Shorts", desc: "Also known as jeans."),
